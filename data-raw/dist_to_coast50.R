...
d <- rnaturalearth::ne_coastline(scale = 50, returnclass = "sf")
...
distance_to_coastline_50 <- setValues(r, as.integer(tib$distance))

usethis::use_data(distance_to_coastline_50)
